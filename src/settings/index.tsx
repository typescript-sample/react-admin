      ...
      <form id="settingsForm" name="settingsForm" model-name="settings" ref={refForm as any}>
        ...
        <div className="row">
          <label className="col s12 m6">
            {resource.language}
            <select id="language" name="language" value={settings.language} onChange={updateState} onBlur={requiredOnBlur}>
          ...
          <label className="col s12 m6">
            ...
            <select id="dateFormat" name="dateFormat" value={settings.dateFormat} onChange={updateState} onBlur={requiredOnBlur}>
