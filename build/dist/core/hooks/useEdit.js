...
import { build, buildId, createEditStatus, createModel as createModel2, handleStatus, handleVersion, initForm, initPropertyNullInModel, message, messageByHttpStatus, useRouter } from 'react-onex';
import { getModelName as getModelName2 } from 'react-onex';
import { useUpdate } from 'react-onex';
import { useMergeState } from 'react-onex';
import { focusFirstError, readOnly } from 'react-onex';
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(flag.newMode === false)) return [3 /*break*/, 5];
                    if (!(patchable === true && body && Object.keys(body).length > 0)) return [3 /*break*/, 2];
                    return [4 /*yield*/, p.service.patch(body)];
                case 1:
                    result = _a.sent();
                    postSave(obj, result, version, isBackO);
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, p.service.update(obj)];
                case 3:
                    result = _a.sent();
                    postSave(obj, result, version, isBackO);
                    _a.label = 4;
                case 4: return [3 /*break*/, 7];
                case 5: return [4 /*yield*/, p.service.insert(obj)];
                case 6:
                    result = _a.sent();
                    postSave(obj, result, version, isBackO);
                    _a.label = 7;
    ...
    var _load = function (_id, callback) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    id = _id;
                    if (!(id != null && id !== '')) return [3 /*break*/, 6];
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, 4, 5]);
                    return [4 /*yield*/, p.service.load(id)];
                case 2:
                    obj = _a.sent();
                    if (!obj) {
