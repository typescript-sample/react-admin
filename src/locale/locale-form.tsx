...
export const LocaleForm = () => {
  ...
  return error500 || (!newMode && !initialLocale) ? (
    ...
    <form id="localeForm" name="localeForm" className="form" ref={refForm}>
      ...
      <div className="row">
        ...
        <label className="col s12 m6">
          ...
          <input type="text" id="name" name="name" value={locale.name} onChange={onChange} maxLength={100} required={true} placeholder={resource.locale_name} />
        </label>
        <label className="col s12 m6">
