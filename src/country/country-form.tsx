...
export const CountryForm = () => {
  ...
  return error500 || (!newMode && !initialCountry) ? (
    <Error title={errorTitle} message={errorMessage} back={back} />
  ) : !canWrite ? (
    <form id="countryForm" name="countryForm" className="form" ref={refForm}>
      <header>
          ...
          <div className="radio-group">
            <label>
              <input
                ...
                name="status"
                value={Status.Active}
                checked={country.status === Status.Active}
                onChange={(e) => {
            ...
            <label>
              <input
                ...
                checked={country.status === Status.Inactive}
                onChange={(e) => {
                  country.status = e.target.value
                  setCountry(country)
                }}
